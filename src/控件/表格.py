...
class Table(QWidget):
    ...
    def initUI(self):
        ...
        # 标头内容
        tableHead = ["标题", "歌手", "专辑", "时长", "mm"]
        # 数据字段
        tableZd = ["title", "songer", "album", "long", "mm"]
        ...
        # print(
        #     [(colIndex + 1, rowIndex, songList[colIndex][tableHead[rowIndex]]) for rowIndex in range(len(tableHead)) for
        #      colIndex in range(len(songList))]
        # )
